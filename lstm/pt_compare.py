...
X1 = torch.load("X1.pt").cpu()
X2 = torch.load("X2.pt").cpu()
Y1 = torch.load("Y1.pt").cpu()
Y2 = torch.load("Y2.pt").cpu()
C1 = torch.load("C1.pt").cpu()
C2 = torch.load("C2.pt").cpu()
H1 = torch.load("H1.pt").cpu()
H2 = torch.load("H2.pt").cpu()
PG1 = torch.load("p1_grad.pt").cpu()
PG2 = torch.load("p2_grad.pt").cpu()
